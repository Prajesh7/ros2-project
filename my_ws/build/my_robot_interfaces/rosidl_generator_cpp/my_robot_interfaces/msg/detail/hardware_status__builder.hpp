...
{
public:
  explicit Init_HardwareStatus_motor_status(::my_robot_interfaces::msg::HardwareStatus & msg)
  : msg_(msg)
  {}
  Init_HardwareStatus_debug_message motor_status(::my_robot_interfaces::msg::HardwareStatus::_motor_status_type arg)
  {
...
public:
  ...
  {}
  Init_HardwareStatus_motor_status temperature(::my_robot_interfaces::msg::HardwareStatus::_temperature_type arg)
  {
