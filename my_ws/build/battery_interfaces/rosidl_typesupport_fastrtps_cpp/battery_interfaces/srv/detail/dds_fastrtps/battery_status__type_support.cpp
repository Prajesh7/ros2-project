...
#include "battery_interfaces/srv/detail/battery_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const battery_interfaces::srv::BatteryStatus_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  battery_interfaces::srv::BatteryStatus_Request & ros_message)
{
  // Member: led_number
  cdr >> ros_message.led_number;
...
{
  auto typed_message =
    static_cast<const battery_interfaces::srv::BatteryStatus_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<battery_interfaces::srv::BatteryStatus_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_battery_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<battery_interfaces::srv::BatteryStatus_Request>()
{
  return &battery_interfaces::srv::typesupport_fastrtps_cpp::_BatteryStatus_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, battery_interfaces, srv, BatteryStatus_Request)() {
  return &battery_interfaces::srv::typesupport_fastrtps_cpp::_BatteryStatus_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_battery_interfaces
cdr_serialize(
  const battery_interfaces::srv::BatteryStatus_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  battery_interfaces::srv::BatteryStatus_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const battery_interfaces::srv::BatteryStatus_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<battery_interfaces::srv::BatteryStatus_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &battery_interfaces::srv::typesupport_fastrtps_cpp::_BatteryStatus_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, battery_interfaces, srv, BatteryStatus_Response)() {
  return &battery_interfaces::srv::typesupport_fastrtps_cpp::_BatteryStatus_Response__handle;
}
...
{
  return &battery_interfaces::srv::typesupport_fastrtps_cpp::_BatteryStatus__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, battery_interfaces, srv, BatteryStatus)() {
  return &battery_interfaces::srv::typesupport_fastrtps_cpp::_BatteryStatus__handle;
}
