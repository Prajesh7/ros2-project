...
#include "battery_interfaces/msg/detail/led_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const battery_interfaces::msg::LedState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<battery_interfaces::msg::LedState *>(
    untyped_ros_message);
...
{
  return &battery_interfaces::msg::typesupport_fastrtps_cpp::_LedState__handle;
}
