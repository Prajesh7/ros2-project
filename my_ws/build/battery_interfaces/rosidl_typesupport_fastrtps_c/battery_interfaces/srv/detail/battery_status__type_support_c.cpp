...
#include "battery_interfaces/srv/detail/battery_status__rosidl_typesupport_fastrtps_c.h"
...
using _BatteryStatus_Request__ros_msg_type = battery_interfaces__srv__BatteryStatus_Request;
...
size_t get_serialized_size_battery_interfaces__srv__BatteryStatus_Request(
  const void * untyped_ros_message,
...
static uint32_t _BatteryStatus_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_battery_interfaces__srv__BatteryStatus_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_battery_interfaces
size_t max_serialized_size_battery_interfaces__srv__BatteryStatus_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _BatteryStatus_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_battery_interfaces__srv__BatteryStatus_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_interfaces, srv, BatteryStatus_Request)() {
...
using _BatteryStatus_Response__ros_msg_type = battery_interfaces__srv__BatteryStatus_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_battery_interfaces
size_t get_serialized_size_battery_interfaces__srv__BatteryStatus_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BatteryStatus_Response__ros_msg_type * ros_message = static_cast<const _BatteryStatus_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_battery_interfaces__srv__BatteryStatus_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_battery_interfaces
size_t max_serialized_size_battery_interfaces__srv__BatteryStatus_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _BatteryStatus_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_battery_interfaces__srv__BatteryStatus_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_interfaces, srv, BatteryStatus_Response)() {
...
// already included above
// #include "battery_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "battery_interfaces/srv/battery_status.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_interfaces, srv, BatteryStatus)() {
