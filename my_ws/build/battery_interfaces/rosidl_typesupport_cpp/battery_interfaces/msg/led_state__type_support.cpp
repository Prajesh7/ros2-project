...
static const _LedState_type_support_symbol_names_t _LedState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, battery_interfaces, msg, LedState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, battery_interfaces, msg, LedState)),
  }
};
...
{
  return &::battery_interfaces::msg::rosidl_typesupport_cpp::LedState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, battery_interfaces, msg, LedState)() {
  return get_message_type_support_handle<battery_interfaces::msg::LedState>();
}
