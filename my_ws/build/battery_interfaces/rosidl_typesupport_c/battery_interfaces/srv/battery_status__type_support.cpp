...
static const _BatteryStatus_Request_type_support_symbol_names_t _BatteryStatus_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_interfaces, srv, BatteryStatus_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battery_interfaces, srv, BatteryStatus_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, battery_interfaces, srv, BatteryStatus_Request)() {
  return &::battery_interfaces::srv::rosidl_typesupport_c::BatteryStatus_Request_message_type_support_handle;
}
...
static const _BatteryStatus_Response_type_support_symbol_names_t _BatteryStatus_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_interfaces, srv, BatteryStatus_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battery_interfaces, srv, BatteryStatus_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, battery_interfaces, srv, BatteryStatus_Response)() {
  return &::battery_interfaces::srv::rosidl_typesupport_c::BatteryStatus_Response_message_type_support_handle;
}
...
static const _BatteryStatus_type_support_symbol_names_t _BatteryStatus_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_interfaces, srv, BatteryStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, battery_interfaces, srv, BatteryStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, battery_interfaces, srv, BatteryStatus)() {
  return &::battery_interfaces::srv::rosidl_typesupport_c::BatteryStatus_service_type_support_handle;
}
