...
bool battery_interfaces__msg__led_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("battery_interfaces.msg._led_state.LedState", full_classname_dest, 42) == 0);
  }
  battery_interfaces__msg__LedState * ros_message = _ros_message;
  {  // a
...
PyObject * battery_interfaces__msg__led_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("battery_interfaces.msg._led_state");
